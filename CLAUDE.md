...
2. Hub hygiene backlog (not blocking the Observatory): placeholder titles (0173, 0130–0133, 0139, 0149, 0165), ~50 legal records without Legal Status, 0318–0321 public fields (kept in Review on purpose), 0245 SSRN metadata verification (then Level 3 / Peer-reviewed source), 0262 Official Source points to the analysed Croatian gazette rather than the ROAT analysis itself (author's choice pending a public URL).
