...
2. Hub hygiene backlog (not blocking the Observatory). Done on 2026-09-06 by prompts 10 and 11: Legal Status on 56 legal-type records, 14 placeholder titles resolved, 0142 rejected as a duplicate of 0120. Still open: ROAT-2026-0174 (Arizona § 28-9702) Jurisdiction `Global` → `Arizona, United States` and a formal title (prompt 11 block D3 was not applied); 0245 and 0263 SSRN metadata — SSRN sits behind a bot check, so the author opens the two abstract pages and pastes title, authors and posting date; 0318–0321 public fields (kept in Review on purpose); 0262 Official Source points to the analysed Croatian gazette rather than the ROAT analysis itself (author's choice pending a public URL).
